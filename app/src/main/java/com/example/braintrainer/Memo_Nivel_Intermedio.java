...
public class Memo_Nivel_Intermedio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_memo_intermedio);
        ...
        chronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
                if((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 70000){
                    PauseChronometer();
                    chronometer.setBase(SystemClock.elapsedRealtime());
                    AlertDialog.Builder builder = new AlertDialog.Builder(Memo_Nivel_Intermedio.this);
                    sonidoperder.start();
                    ...
                    builder.setNegativeButton("Salir", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(Memo_Nivel_Intermedio.this ,NivelesMemorama.class);
                            startActivity(i);
                            finish();
                        }
                    });
    ...
    public void CargarImagenes(){
        imagenes = new int []{
                R.drawable.mariobros1,
                R.drawable.mario_luigi,
                R.drawable.amigosmario,
                R.drawable.yoshi,
                R.drawable.bowser,
                R.drawable.toad,
                R.drawable.luigi,
